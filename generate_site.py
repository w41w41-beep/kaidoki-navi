...
<body>
    ...
    <div class="container content">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <a href="https://amzn.to/4nv27Kr" target="_blank">
                    <img src="https://m.media-amazon.com/images/I/51AccyP34JL._AC_SY355_.jpg" alt="商品画像">
                    <div class="product-info">
                        <div class="product-name">Powerun「2025業界新登場！」 エアタグ（2個セット）airtag MFI認証済み 紛失防止タグ Appleの「探す」に対応(iOS端末のみ) スマートトラッカー 全地球測位 gpsタグ 小型 超薄 超軽量 スマートタグ 子供/高齢者/ペット見守り 鍵/車/自転車/荷物/財布/バッグ 忘れ物防止 母の日 父の日 敬老の日 お誕生日プレゼント (F2)</div>
